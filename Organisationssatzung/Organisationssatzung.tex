...
\begin{contract}
  ...
  Rahmen der gesetzlichen Bestimmungen selbst'. Sie wahrt nach den
  verfassungsrechtlichen Grundsätzen die weltanschauliche, religiöse und
...
\begin{contract}
  ...
  der studentischen Sitze in den Gremien der Universität und des Studierendenwerks
  ...
  'S Wird ein Mitglied in drei Sitzungen in Folge nicht vertreten, so ruht eine
  Mitgliedschaft ab dem Ende dieser 3. Sitzung bis wieder eine*n
  Vertreter*in in den Studierendenrat entsendet wird'. Ruht die Mitgliedschaft eines
  Fachbereichs, so muss dies durch das Studierendenratspräsidium baldmöglichst
  dem Studierendenrat sowie dem Studierendenratsmitglied mitgeteilt und in
  der nächsten Studierendenratssitzung bekannt gegeben werden'. So lange die
  Mitgliedschaft ruht, wird diese nicht zur Anzahl der zur Berechnung
  der Beschlussfähigkeit und der Mehrheiten herangezogenen Mitglieder
  hinzugezählt.

  'S Der Studierendenrat beschließt über
  \begin{enumerate}[\qquad 1.]
    \item Änderungen der Organisationssatzung sowie die Wahl und Abwahl von
      WSSK-Mitgliedern mit der Zustimmung der Stimmen von zwei Dritteln seiner
      an der Abstimmung teilnehmenden Mitglieder (Zwei-Drittel-Mehrheit),
    \item die Wahl der Vorsitzenden und der anderen AStA Mitglieder, die Abwahl
      ...
      der Stimmen seiner an der Abstimmung teilnehmenden Mitglieder (absolute
      Mehrheit) und 3. alle anderen Angelegenheiten mit der Mehrheit der
      abgegebenen Stimmen ohne Berücksichtigung der Enthaltungen (einfache
      Mehrheit).
  \end{enumerate}
...
\begin{contract}
  ...
  'S (entfällt)\footnote{Das Rektorat will, dass dieser Absatz durch Absatz 5
    ersetzt wird. Absatz 6 wird zu 5. Absatz 7, weil man die Satzung nicht
    angeschaut hat, bleibt 7.}
...
\begin{contract}
  ...
  'S Der Vorstand besteht aus mindestens einer* Vorsitzenden und den
  ...
  \item Studierende, die von Rassismus betroffen sind
...
\begin{contract}
  ...
  geführt wird'. Die Vorsitzenden entwerfen zusammen mit dem*der Beauftragten für den
  ...
  gelten soll'. Die Finanzstelle und die*der Haushaltsbeauftragte leitet den
  beschlossenen Haushalts-/Wirtschaftsplan an das Rektorat der
  Albert-Ludwigs-Universität Freiburg zur Genehmigung weiter; die Genehmigung
  darf nur versagt werden, wenn der Haushalts-/Wirtschaftsplan rechtswidrig ist.
